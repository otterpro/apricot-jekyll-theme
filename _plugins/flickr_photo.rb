...
#
# Modified by Daniel Kim (otter.pro)
# Use "large" as default, instead of "medium" (line 49)
# Remove "thumbnail" class in <a>
# Add image size as class in <img> , i.e. <img class="Large"...> for large size
# Add exception in case of an error (i.e no internet connection)
# MAYBE: add option in config.yml
